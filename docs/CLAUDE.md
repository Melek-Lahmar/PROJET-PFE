...
- **Frontend:** `flutter/CLAUDE.md` — covers the Flutter app's role-based shell, provider scoping rules, status code mappings, and feature-slice conventions.
...
See `flutter/CLAUDE.md` for the full guide. Key points that affect cross-cutting work:
