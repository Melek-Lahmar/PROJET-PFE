    ...
    public class OrdersController : ControllerBase
    {
        ...
        private static BonCommandeResponseDto MapToResponse(F_DOCENTETE e, List<F_DOCLIGNE> lignes, F_LIVRAISON? livraison)
        {
            return new BonCommandeResponseDto
            {
                ...
                TotalBeforeDiscount = e.TotalBeforeDiscount ?? e.DO_TotalTTC ?? 0m,
                B2BDiscountRate = e.B2BDiscountRate,
                B2BDiscountAmount = e.B2BDiscountAmount ?? 0m,
                DiscountSource = e.DiscountSource,
