    ...
    public class AdminBackofficeController : ControllerBase
    {
        ...
        public async Task<ActionResult<AdminOrderDetailDto>> GetOrderByPiece(string piece, CancellationToken ct)
        {
            ...
            var dto = new AdminOrderDetailDto
            {
                ...
                TotalBeforeDiscount = header.TotalBeforeDiscount ?? header.DO_TotalTTC ?? 0m,
                B2BDiscountRate = header.B2BDiscountRate,
                B2BDiscountAmount = header.B2BDiscountAmount ?? 0m,
                DiscountSource = header.DiscountSource,
